    ...
    <nav className={styles.navbar}>
      <div className={styles.navbarContainer}>
        ...
        <div className={`${styles.navbarLinks} ${isMobileMenuOpen ? styles.mobileMenuOpen : ''}`}>
          ...
          <Link href="/dashboard/courses" className={pathname === "/dashboard/courses" ? styles.active : ""} onClick={closeMobileMenu}>
            Courses
          </Link>
          <Link href="/dashboard/registration" className={pathname === "/dashboard/registration" ? styles.active : ""} onClick={closeMobileMenu}>
            Registration
          </Link>
          <Link href="/dashboard/profile" className={pathname === "/dashboard/profile" ? styles.active : ""} onClick={closeMobileMenu}>
            Profile
          </Link>
          ...
          <div className={styles.navbarUser}>
            ...
            {isDropdownOpen && (
              <div className={styles.userDropdown}>
                <Link href="/dashboard/profile" className={styles.dropdownItem} onClick={() => setIsDropdownOpen(false)}>
                  Profile
                </Link>
